          ...
          >
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="https://www.linkedin.com/in/madhankumar-sv/" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-muted-foreground hover:text-primary transition-colors text-sm">
                  <Linkedin size={18} /> www.linkedin.com/in/madhankumar-sv
                </a>
