  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center section-padding pt-32">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          Software Engineer | Python | Automation | Backend | AI &amp; Reinforcement Learning
        </motion.p>
        ...
        >
          <a href="https://github.com/000MK" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
            <Github size={20} />
          </a>
          <a href="https://www.linkedin.com/in/madhankumar-sv/" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
            <Linkedin size={20} />
          </a>
          <a href="mailto:madhankumarsv000@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
            <Mail size={20} />
          </a>
        </motion.div>
